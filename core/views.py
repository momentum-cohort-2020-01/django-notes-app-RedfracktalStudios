...
def createtodo(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'core/createtodo.html', {'form': TodoForm(), 'error': 'Bad data.  Try again'})
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'core/viewtodo.html', {'todo': todo, 'form': form, 'error': 'Bad data.  Try again'})
